...
print("----- Evaluate using hard threshold -----")
...
for ind_image, crrt_image in enumerate(list_images):
    for crrt_embedding in list_embeddings:
        ...
        inst_dummy_stego.perform_substitution(proportion_hiding=crrt_embedding)
...
print("Done evaluating with hard threshold!\n")
        
print("----- Evaluate using relative slope -----")
...
print("Done evaluating with relative slope!\n")
